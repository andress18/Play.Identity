        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation($"User added to {Roles.Player} role.");

                    await _publishEndpoint.Publish(new UserUpdated(user.Id, user.Email, user.Gil), CancellationToken.None);
